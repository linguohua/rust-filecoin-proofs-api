...
fn generate_winning_post_inner<Tree: 'static + MerkleTreeTrait>(
    ...
    info!("generate_winning_post_inner load p_aux files end, took:{:#?}", time_start.elapsed());
...
fn generate_window_post_inner<Tree: 'static + MerkleTreeTrait>(
    ...
    info!("generate_window_post_inner load p_aux files end, took:{:#?}", time_start.elapsed());
